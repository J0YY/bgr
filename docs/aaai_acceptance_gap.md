...
not sync or interpret those rows. Latest poll/sync at 2026-06-11 10:02:21 BST
...
matched random 202/288. This route is not gateable yet, but it is effectively
closed unless BGR succeeds on at least 105 of its remaining 106 episodes; do
not interpret it until the complete 400-episode BGR/random rows are synced.
Poll/sync:
...
2026-06-11 10:02:48 BST showed official `783104` and BGR `783105` running,
matched random `783106` pending on unavailable nodes, and an early incomplete
summary of BGR 60/81 versus official 57/82. This is only a severity-window
