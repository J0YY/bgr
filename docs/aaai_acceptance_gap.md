...
the 2026-06-11 03:43:39 BST poll had BGR occlusion `40/50`, official `41/53`,
and matched random `45/55`; this is an early non-positive signal against
matched random, not a gateable result. Poll/sync with:
