# OpenVLA-OFT Random-Balanced-2048 HDF5 Pack

This remote artifact validates and packs
`openvla_teacher_oft_random_balanced2048_v1` into a LIBERO-style HDF5 dataset.
...
full HDF5 pack is 399M and remains under `/work`.
