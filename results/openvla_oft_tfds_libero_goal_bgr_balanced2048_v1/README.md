# OpenVLA-OFT LIBERO-Named BGR-Boundary Balanced-2048 TFDS

This remote artifact exports the BGR-boundary 2,048-step rendered set under the
stock OpenVLA-OFT dataset name `libero_goal_no_noops`, so the unmodified
OpenVLA-OFT LIBERO registry can load it.
