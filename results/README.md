...
`783315`; latest guarded advance at 2026-06-11 13:08:44 BST ran
...
running on `c1-g4-05`, BGR is running on `c1-g4-04`, and matched random is
pending on `Resources`; estimated start is 2026-06-11 14:21:02 BST for matched
...
the local incomplete summary has BGR occlusion_shift 13/21 and official
occlusion_shift 44/73 successes.
