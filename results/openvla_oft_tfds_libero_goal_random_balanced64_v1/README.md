# OpenVLA-OFT LIBERO-Named Random-Balanced-64 TFDS

This artifact exports the random-balanced 64-step rendered set under the stock
OpenVLA-OFT dataset name `libero_goal_no_noops`, so the unmodified OpenVLA-OFT
LIBERO registry can load it as a matched baseline.
