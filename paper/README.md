...
A fixed pre-existing-dataset OpenML margin-replay follow-up is also included.
The original diabetes 30-seed run in
...
sensitivity check in `results/openml_positive_target_sensitivity_30seed_v1/summary.csv`
and held-out repeat in
`results/openml_positive_target_sensitivity_replication_30seed_v1/summary.csv`
are a caveat: pooled BGR-minus-uniform gaps for diabetes/blood/phoneme are
+0.002/-0.002/-0.007 at radius 1.0, +0.032/+0.065/+0.014 at 1.5, and
+0.038/+0.086/+0.035 at 2.0. The paper frames these as supervised
margin-replay evidence, not standard-environment or robotics results.
