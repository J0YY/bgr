...
\end{tabular}}
\caption{Instantiations of the BGR interface. The first four rows are training experiments or supervised margin checks; the OpenVLA row is an audit of recovery curves and data plumbing, not a fine-tuning claim.}
\label{tab:interface}
\end{table}
