...
The next stage instantiates replayable states in MiniGrid-style environments with resettable seeds and checkpointed states. Perturbations include start-pose offsets and instruction-preserving object edits with reachability filters. Baselines include uniform replay, PLR-style loss priority, failure-only replay, fixed-radius training, random-radius perturbation, and BGR ablations.
