...
\caption{Selected paired effect sizes for the central claims, including the completed 30-seed estimator, grid, and suffix full-baseline confirmations. Mean differences and 95\% confidence intervals are computed over paired seeds; W/L/T counts paired wins, losses, and ties in the declared improvement direction; $p$ is the exact two-sided paired sign-test value. The synthetic comparison uses 15 paired seeds; estimator, grid full-baseline, and suffix coverage-full comparisons use 30 paired seeds.}
