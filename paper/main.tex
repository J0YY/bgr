...
bsuite screens & DeepSea BGR 0.1125; Catch BGR 0.8446; Cartpole BGR-Cov. 0.7559 & Catch uniform 0.8782; Cartpole TD-loss 0.7694; r80 often lower/near-ceiling & negative\\
...
Table~\ref{tab:scope-audits} keeps the scope explicit. FrozenLake has a small BGR RAUC edge but loses paired-sign and complementary-metric checks; MiniGrid, PointMaze, FetchReach, Reacher, and bsuite screens fail against stronger baselines, complementary radius metrics, or paired wins; and InvertedPendulum ties all methods. LunarLander is a near miss: BGR-Coverage has the best mean RAUC (0.7500 vs. 0.6222 uniform) but wins only 2/4 seeds and has lower median $r_{80}$. bsuite Catch shows scale-up fragility (0.8446 vs. 0.8782 uniform after a positive 4-seed screen), and bsuite Cartpole is also negative: default BGR loses to uniform on all four paired seeds (0.7464 vs. 0.7577), while BGR-Coverage trails TD-loss replay (0.7559 vs. 0.7694). InvertedDoublePendulum-v5 gives a tiny BGR RAUC edge (0.0833 vs. 0.0035 uniform) but collapses clean success to 0.2500 for BGR and 0.0000 for BGR-Coverage. Two follow-ups close simple rescue paths: widening FourRooms perturbations to Manhattan radius 10 leaves BGR-Coverage at 0.1031 vs. 0.1014 uniform (W/L/T=2/2/0) with saturated $r_{80}=1.0000$, and a HandReach-v3 random-shooting calibration fails clean success (0.0000) before method comparison. A highway-fast-v0 lane-keeping calibration also fails before method comparison: clean success is 0.6667, recovery ranges only from 0.5833 to 0.6667, and $r_{80}=6.0000$ saturates at the maximum tested radius. Other local tabular and classic-control probes remain internal diagnostics rather than manuscript evidence.
