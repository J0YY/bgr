...
and matched random `783315`; latest guarded advance at 2026-06-11 13:08:44 BST
...
`c1-g4-04`, and matched random `783315` is pending on `Resources`; estimated
start is 2026-06-11 14:21:02 BST for matched random. A direct scheduler check at
...
local incomplete summary has BGR occlusion_shift 13/21 and official
occlusion_shift 44/73 successes. This is
