...
not sync or interpret those. Latest poll/sync at 2026-06-11 09:48:26 BST
...
matched random 123/203, so the route is not gateable and is trending negative.
Poll/sync:
...
This is a severity-window scout only, not a paper claim and not a replacement
for the fixed gate. Use it only to decide whether a future preregistered
router-style gate is worth running; promotion would still require BGR to beat
both official and matched random by at least +10/400 and +0.02 on a fixed
400-episode readout.
