...
| The independent standard-environment diagnostic is a limitation, not a support claim. | `results/frozenlake_recovery_focused_30seed_v1/summary.csv`, `results/frozenlake_recovery_focused_30seed_v1/results.json`, `results/lunarlander_recovery_probe_4seed_v1/summary.csv`, `results/reacher_recovery_probe_12seed_v1/summary.csv` | `scripts/check_paper_claims.py` checks the FrozenLake, LunarLander, and Reacher limitation prose and verifies that paired signs or robustness metrics do not support a clean BGR win. |
