...
| The independent standard-environment diagnostic is a limitation, not a support claim. | `results/frozenlake_recovery_focused_30seed_v1/summary.csv`, `results/frozenlake_recovery_focused_30seed_v1/results.json` | `scripts/check_paper_claims.py` checks the FrozenLake limitation prose and verifies that the paired signs and robustness metrics do not support a clean BGR win. |
