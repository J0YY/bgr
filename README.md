...
| The independent standard-environment diagnostic is a limitation, not a support claim. | `results/frozenlake_recovery_focused_30seed_v1/summary.csv`, `results/frozenlake_recovery_focused_30seed_v1/results.json`, `results/reacher_recovery_probe_12seed_v1/summary.csv` | `scripts/check_paper_claims.py` checks the FrozenLake and Reacher limitation prose and verifies that the paired signs and robustness metrics do not support a clean BGR win. |
