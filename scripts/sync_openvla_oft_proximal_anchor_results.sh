...
PROXIMAL_TAG="${PROXIMAL_TAG:-proxanchor_l2_1em0_ddpgradfix_v1}"
...
JOB_IDS="${JOB_IDS:-767657,767658,767659,767660,767661,767662,767663,767664,767665,767666,767667,767674,767675,767676,767677,767678,767681,767682,767683,767684,767685}"
DETAIL_JOB_IDS="${DETAIL_JOB_IDS:-767657,767674,767681}"
