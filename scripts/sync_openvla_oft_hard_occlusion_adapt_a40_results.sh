...
export JOB_IDS="${JOB_IDS:-774816,774817,774818,774819,774820,774821,774822,774846,774847,774848,774849,774850,774851,775102,775103}"
export DETAIL_JOB_IDS="${DETAIL_JOB_IDS:-774816,774817,774820,774846,774848,774850,775102,775103}"
