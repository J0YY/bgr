...
COMPARISONS = [
    ...
    Comparison("Grid margin ablation 30-seed", "grid_margin_ablation_30seed_v1/summary.csv", "bgr", "bgr_uniform_radius", "final_rauc"),
    Comparison("Grid margin ablation 30-seed", "grid_margin_ablation_30seed_v1/summary.csv", "bgr", "bgr_uniform_radius", "rauc_aulc"),
    Comparison("Grid margin ablation 30-seed", "grid_margin_ablation_30seed_v1/summary.csv", "bgr_uniform_radius", "uniform", "final_rauc", "lower"),
    Comparison("Grid margin ablation 30-seed", "grid_margin_ablation_30seed_v1/summary.csv", "bgr_uniform_radius", "uniform", "rauc_aulc", "lower"),
    Comparison("Grid margin ablation 30-seed", "grid_margin_ablation_30seed_v1/summary.csv", "bgr", "bgr_no_uncertainty", "final_rauc"),
    Comparison("Grid margin ablation 30-seed", "grid_margin_ablation_30seed_v1/summary.csv", "bgr", "bgr_no_sharpness", "final_rauc"),
    Comparison(
        "Grid margin ablation replication 30-seed",
        "grid_margin_ablation_replication_30seed_v1/summary.csv",
        "bgr",
        "bgr_uniform_radius",
        "final_rauc",
    ),
