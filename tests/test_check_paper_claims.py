...
def expected_rows() -> list[tuple[str, str, str, str, str, bool, int, int]]:
    rows = [
        ...
        ("Grid margin ablation 30-seed", "", "final_rauc", "bgr", "bgr_uniform_radius", True, 30, 0),
        ("Grid margin ablation 30-seed", "", "rauc_aulc", "bgr", "bgr_uniform_radius", True, 30, 0),
        ("Grid margin ablation 30-seed", "", "final_rauc", "bgr_uniform_radius", "uniform", True, 30, 0),
        ("Grid margin ablation 30-seed", "", "rauc_aulc", "bgr_uniform_radius", "uniform", True, 30, 0),
        ...
        ("Robot suffix strategy ablation 30-seed", "", "final_rauc", "bgr_broad", "uniform", True, 30, 0),
        ("Robot suffix strategy ablation 30-seed", "", "final_rauc", "bgr_boundary", "uniform", True, 30, 0),
        ("Robot suffix strategy ablation 30-seed", "", "final_rauc", "bgr_broad", "bgr_boundary", True, 30, 0),
        ("Robot suffix strategy ablation 30-seed", "", "final_rauc", "bgr_broad", "bgr_hard", True, 30, 0),
        ("Robot suffix strategy ablation 30-seed", "", "final_transfer_rauc", "bgr_hard", "uniform", True, 30, 0),
        ("Robot suffix strategy ablation 30-seed", "", "rauc_aulc", "bgr_hard", "uniform", True, 30, 0),
