...
from tools.minatar_asterix_recovery_probe import (
    LinearSoftmaxPolicy,
    aggregate_rows,
    parse_ints,
    parse_strings,
...
class MinAtarAsterixRecoveryProbeTest(unittest.TestCase):
    ...
    def test_linear_policy_update_reduces_teacher_loss(self) -> None:
        ...
        before = policy.loss(features, 4)
        policy.update(features, 4)
        after = policy.loss(features, 4)
    ...
    def test_sample_pair_bgr_uniform_radius_uses_state_priority_and_uniform_radius(self) -> None:
        ...
        self.assertLessEqual(sigma, 8.0)
