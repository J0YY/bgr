        ...
        readme.write_text(
            "\n".join(
                [
                    ...
                    "",
                    "- `results/toy_15seed_v1/summary.csv`: 15 paired seeds for the controlled synthetic recovery-margin benchmark.",
                    "- `results/toy_30seed_v1/summary.csv`: 30-seed synthetic mechanism confirmation.",
                    ...
                    "- `paper/figures/grid_margin_learning_rate_sensitivity_stats.csv` and `results/grid_margin_learning_rate_sensitivity_15seed_v1/summary.csv`: learning-rate scope diagnostic.",
                    "- `results/grid_margin_learning_rate_sensitivity_30seed_v1/summary.csv`: 30-seed learning-rate confirmation.",
                    "- `paper/figures/grid_margin_regime_sensitivity_stats.csv` and `results/grid_margin_regime_sensitivity_15seed_v1/summary.csv`: regime sensitivity diagnostic.",
                    "- `results/grid_margin_regime_sensitivity_30seed_v1/summary.csv`: 30-seed regime diagnostic confirmation.",
                    "- `paper/figures/grid_margin_stress_sensitivity_stats.csv` and `results/grid_margin_stress_sensitivity_15seed_v1/summary.csv`: geometry stress diagnostic.",
                    "- `results/grid_margin_stress_sensitivity_30seed_v1/summary.csv`: 30-seed stress confirmation.",
                    "",
            ...
            readme.write_text(
                "\n".join(
                    [
                        ...
                        "30-seed regime diagnostic confirmation",
